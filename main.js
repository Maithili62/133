...
if (status1 != "")
{
    for (i=0; i<objects.length; i++)
    {
        ...
        document.getElementById("info").innerHTML = "There are 3 big objects in the image from which cocossd model has detected " + objects.length + " objects";
        noFill();
...
if (status2 != "")
{
    ...
    {
        document.getElementById("status").innerHTML = "Status : Objects Detected";
        document.getElementById("info1").innerHTML = "There are 2 big objects in the image from which cocossd model has detected " + objects1.length + " objects";
        noFill();
...
if (status3 != "")
{
    ...
    {
        document.getElementById("status").innerHTML = "Status : Objects Detected";
        document.getElementById("info2").innerHTML = "There are 3 big objects in the image from which cocossd model has detected " + objects2.length + " objects";
        noFill();
...
if (status4 != "")
{
    ...
    {
        document.getElementById("status").innerHTML = "Status : Objects Detected";
        document.getElementById("info3").innerHTML = "There are 3 big objects in the image from which cocossd model has detected " + objects3.length + " objects";
        noFill();
...
if (status5 != "")
{
    ...
    {
        document.getElementById("status").innerHTML = "Status : Objects Detected";
        document.getElementById("info4").innerHTML = "There are 3 big objects in the image from which cocossd model has detected " + objects4.length + " objects";
        noFill();
...
if (status6 != "")
{
    ...
    {
        document.getElementById("status").innerHTML = "Status : Objects Detected";
        document.getElementById("info5").innerHTML = "There are 3 big objects in the image from which cocossd model has detected " + objects5.length + " objects";
        noFill();
